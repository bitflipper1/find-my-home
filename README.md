...
GMAIL_CLIENT_SECRET=...
GMAIL_REFRESH_TOKEN=...
GMAIL_USER_EMAIL=***REDACTED-EMAIL***
```

The server will then scan your inbox at ***REDACTED-EMAIL*** for builder emails, Zillow alerts, price-drop notifications, and open house invites.
