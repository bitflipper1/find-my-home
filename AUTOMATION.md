...
A scheduled task scans your Gmail connector (`mattmcg@bitfliptech.com`) for new
...
- **Builder emails** — Ryan Homes (`carolinasteam@ryanhomes.com`), David Weekley (`jwian@dwhomes.com`), and others
